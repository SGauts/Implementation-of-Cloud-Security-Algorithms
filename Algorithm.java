...
public final class Algorithm // implicit no-argument constructor
{
    /**
    ...
    static final boolean DEBUG = Algo_Properties.GLOBAL_DEBUG;
    static final int debuglevel = DEBUG ? Algo_Properties.getLevel(NAME) : 0;
    static final PrintWriter err = DEBUG ? Algo_Properties.getOutput() : null;
    static final boolean TRACE = Algo_Properties.isTraceable(NAME);
    /**
